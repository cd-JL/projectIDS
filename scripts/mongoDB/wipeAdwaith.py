...
# Step 1: Retrieve sensorId and ObjectId for the device with name 'Adwaith2004'
sensor = sensors_collection.find_one({"deviceName": "Adwaith2004"})

if sensor:
    sensor_id = sensor.get("sensorId")
    object_id = sensor.get("_id")
    print(f"Found sensor with sensorName 'Adwaith2004': sensorId = '{sensor_id}', objectId = '{object_id}'")
    ...
    print("No sensor found with the name 'Adwaith2004'.")
